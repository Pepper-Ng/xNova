      ...
      switch ($ress) {
         case 'metal':
            if($action == "trade")
            {
               ...
               {
                  $trade   = ($crystal * 2 + $deut * 3 + $norio * 4);
         ...
         case 'crystal':
            if($action == "trade")
            {
               ...
               {
                  $trade   = ($metal * 0.5 + $deut * 1.5 + $norio * 2);                  
                  $PlanetRess->CalcResource();
         ...
         case 'deuterium':
            if($action == "trade")
            {
               ...
               {
                  $trade   = ($metal * 0.35 + $crystal * 0.75 + $norio * 1.35);   #si norio se multplica por (1) da el mismo resultado               
                  $PlanetRess->CalcResource();
         ...
         case 'norio':
            if($action == "trade")
            {
               ...
               {
                  $trade = ($metal * 0.25 + $crystal * 0.5 + $deut * 0.75);         
                  $PlanetRess->CalcResource();
