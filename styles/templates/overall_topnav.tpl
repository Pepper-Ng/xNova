...
window.setTimeout(function(){
	...
	resourceTicker({ cur: {round($metal)}, limit: {$js_metal_max}, hr: {$js_metal_hr}, elem: "current_metal", startTime: curTime }, true);
	resourceTicker({ cur: {round($crystal)}, limit: {$js_crystal_max}, hr: {$js_crystal_hr}, elem: "current_crystal", startTime: curTime }, true);
	resourceTicker({ cur: {round($deuterium)}, limit: {$js_deuterium_max}, hr: {$js_deuterium_hr}, elem: "current_deuterium", startTime: curTime }, true);
	resourceTicker({ cur: {round($norio)}, limit: {$js_norio_max}, hr: {$js_norio_hr}, elem: "current_norio", startTime: curTime }, true)
}, 1000);
</script>