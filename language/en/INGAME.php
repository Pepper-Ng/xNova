...
$LNG['rang_1']  = 'Primitive Civilization';
$LNG['rang_2']  = 'Planetary Civilization';
$LNG['rang_3']  = 'Space Civilization';
$LNG['rang_4']  = 'Colonial Civilization';
$LNG['rang_5']  = 'Advanced Civilization';
$LNG['rang_6']  = 'Stellar Empire';
$LNG['rang_7']  = 'Galactic Empire';
$LNG['rang_8']  = 'Advanced Empire';
$LNG['rang_9']  = 'Dominating Empire';
$LNG['ov_fragatas'] = "Cargo ships: ";
$LNG['ov_cazador'] = "Fighters: ";
$LNG['ov_civil'] = "Civil Ships: ";
$LNG['ov_cruceros'] = "Cruisers: ";
$LNG['ov_insignia'] = "Insignia Ships: ";
$LNG['ov_capital'] = "Capital Ships: ";
...
$LNG['ov_subiendo']							= 'Raising level';
$LNG['ov_cantidad']							= 'Building';
$LNG['ov_estructuras_construccion']     	= 'Constructions';

$LNG['ov_free_estructuras']					= 'No planetary structures are being built.';
$LNG['ov_free_hangar']						= 'Noting being built in the hangar of this planet.';
...
# Bonus
$LNG['packs_darkmatter'] 		= "Darkmatter";
$LNG['packs_en_venta'] 			= "Packs for sale";
$LNG['packs_comprar'] 			= "Buy";
$LNG['packs_coste'] 			= "Price: ";
$LNG['recursos_pack'] 			= "Resources pack";
$LNG['recursos_pack_descr'] 	= "Metal : +10.000.000 <br />Crystal : +5.000.000 <br />Deuterium : +2.500.000";
$LNG['minas_pack'] 				= "Miner pack";
$LNG['minas_pack_descr'] 		= "Metal Mine +2 <br />Crystal Mine +2 <br />Deuterium Refinery +2 <br />Solar Power Plant +5 <br />Robot Factory +2";
$LNG['almacenes_pack'] 			= "Storage Pack";
$LNG['almacenes_pack_descr'] 	= "Metal Storage +1 <br />Crystal Storage +1 <br />Deuterium Storage  +1 <br />Norium Storage  +1 ";
$LNG['flotas_pack'] 			= "Fleet Pack";
$LNG['flotas_pack_descr']  		= "Light Fighter: +300.000 <br />Heavy Fighter : +150.000 <br />Mega-Recycler : +500 <br />Deuterium : +3.000.000 ";
$LNG['bunkers_pack'] 			= "Defence Pack";
$LNG['bunkers_pack_descr'] 		= "Small Shield Dome +1 <br />Large Shield Dome +1 <br />Atmospheric Shield +1 <br />Ion cannons: +20.000 ";
$LNG['tecnos_pack'] 			= "Technology Pack";
$LNG['tecnos_pack_descr'] 		= "Spy Technology +1 <br />Computer Technology +1 <br />Energy Technology +1 <br />Combustion Engine +1 <br />Impulse Engine +1 <br />Hyperspace Engine  +1 ";
$LNG['bn_pack_ok'] 				= "You bought this pack.";
$LNG['bn_pack_no'] 				= "Not enough dark matter ..";
...
$LNG['gl_out_space']						= 'Start an expedition in this System';
$LNG['gl_avaible_missiles']					= 'Missiles';
$LNG['gl_fleets']							= 'Fleet Slots';
$LNG['gl_avaible_grecyclers']				= 'YoMo-Recyclers';
...
$LNG['iv_ships']							= 'Ships';
$LNG['iv_defenses']							= 'Defence';

//----------------------------------------------------------------------------//
//FLEET - FLEET1 - FLEET2 - FLEET3 - FLEETACS - FLEETSHORTCUTS

$LNG['fl_titulo_misiones']					= 'ACTIVE MISSIONS';
$LNG['fl_no_misiones']						= 'No active missions';
...
$LNG['fl_colonisation_planet_limit']		= 'Maximum amount of %s planets reached! Upgrade Expedition technology?';
...
$LNG['tr_almacenes']						= 'Information on the capacity of your warehouse, you can see it in your resource drive or resource management.';
$LNG['tr_elemento'] 						= 'Buy shares with ';
...
$LNG['tr_descr']							= 'Resources provided by a merchant can exceed the storage capacity.';
...
$LNG['al_nivel_error']								= '<center><img width="120" height="120" src="styles/images/rangos/3.png" /></center><br /><b>You must be at least Level 3 to create an alliance.<br /> To get to level 3 is necessary to have more than 10,000 points</b>.';
...
$LNG['cff_mission_own_mip']					= 'Missile attack (%d) from %s %s %s on location %s %s %s.';
$LNG['cff_mission_own_expo_0']				= 'A %s from %s %s %s approaching on location %s. Mission: %s';
$LNG['cff_mission_own_expo_1']				= 'A %s comes back from position %s to location %s %s %s. Mission: %s';
$LNG['cff_mission_own_expo_2']				= 'A %s from %s %s %s where on expedition from position %s. Mission: %s';
$LNG['cff_mission_own_recy_0']				= 'A %s from %s %s %s is heading to debris field %s. Mission: %s';
$LNG['cff_mission_own_recy_1']				= 'A %s returns from debris field %s to location %s %s %s. Mission: %s';
$LNG['cff_mission_target_bad']				= 'A hostile %s from player %s from %s %s %s spying to location %s %s %s. Mission: %s';
$LNG['cff_mission_target_good']				= 'A hostile %s from player %s from %s %s %s spying to location %s %s %s. Mission: %s';
$LNG['cff_mission_target_stay']				= 'A peaceful %s from player %s from %s %s %s is in orbit on %s %s %s. Mission: %s';
$LNG['cff_mission_target_mip']				= 'Missile attack (%d) from player %s from %s %s %s to location %s %s %s.';
...
$LNG['ma_no_missiles']						= 'No Missiles';
$LNG['ma_add_missile_number']				= 'More missiles needed: ';
...
$LNG['ma_all']								= 'All';
$LNG['ma_missiles_sended']					= ' Missile deployed. Destroyed objects: ';
...
$LNG['tkb_unentschieden']         			= '<b>-Both players, undecided- </b>';
...
$LNG['sendit_error_msg'] 					= 'You forgot to type something! ';
