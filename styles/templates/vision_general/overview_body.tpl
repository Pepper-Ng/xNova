  	...
  	<div id="caja">
          	...
          	<div id="titular">
            	<div id="estructura_titular" style="position:relative;">
         			<div id="titular_texto" style="display: block;">
                		<a href="#" onClick="$('#dialog').dialog('open');return false;" title="{$ov_planetmenu}">{$ov_planet} "<span>{$planetname}</span>"</a> ({$username})
              		</div>
            	</div>
          	</div>
        </div> 
        ...
        <div id="contenidoMostrado">                               
            <div id="elCosoxD">
                ...
                <div id="rangos_ov">
                    <img class="tooltip" name="<img src=styles/images/rangos/{$rango}.png /><br /><h3>{$lvl_rg} {$rango}<br />{$nivel}</h3> " src="styles/images/rangos/{$rango}.png" width="70" height="70" />
                </div>
                <div id="luna_ov">
                    {if $Moon}
